...
mod.dat$AP_at_AP<-ifelse(mod.dat$AP_rank_home==1 & mod.dat$AP_rank_away==1, 1, 0)
mod.dat$AP_at_non<-ifelse(mod.dat$AP_rank_home==0 & mod.dat$AP_rank_away==1, 1, 0)
mod.dat$non_at_AP<-ifelse(mod.dat$AP_rank_home==1 & mod.dat$AP_rank_away==0, 1, 0)
mod.dat$non_at_non<-ifelse(mod.dat$AP_rank_home==0 & mod.dat$AP_rank_away==0, 1, 0)
